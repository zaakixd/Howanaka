...
export default function GuildWelcome() {
  ...
  useEffect(() => {
    if (config) {
      setEnabled(config.welcome.enabled);
      setChannelId(config.welcome.channelId || "");
      setMessage(config.welcome.message || "");
      setEmbedId(config.welcome.embedId || "none");
    }
  }, [config]);
    ...
    updateConfig.mutate({
      ...
      onSuccess: () => {
        toast({
          ...
          description: "Welcome system configuration has been updated.",
        });
  ...
  return (
    <DashboardLayout>
      <div className="p-6 md:p-10 max-w-4xl mx-auto space-y-8">
        <div>
          <h1 className="text-3xl font-extrabold tracking-tight mb-2">Welcome System</h1>
          <p className="text-muted-foreground">Greet new members when they join your server.</p>
        </div>
            ...
            <CardHeader>
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <CardDescription>Configure where and how to welcome users.</CardDescription>
                </div>
                <div className="flex items-center gap-2">
                  <Label htmlFor="welcome-enable" className="text-sm font-medium">
              ...
              <div className={`space-y-6 transition-opacity ${!enabled ? 'opacity-50 pointer-events-none' : ''}`}>
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-xs text-muted-foreground mt-2">
                    Click a variable above to see what it does, or type it directly in the message box.
                  </p>
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-xs text-muted-foreground">
                    You can create custom embeds in the Embeds tab.
                  </p>
                </div>
              </div>
            </CardContent>
